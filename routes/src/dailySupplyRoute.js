...
router.post('/nguyen-lieu/updateData/:id', authMiddlewares.ensureRoles(['Admin', 'Hàm lượng', 'Văn phòng', 'Giám đốc']),checkDateAccess, dailySupplyController.supplierInputController.updateSupplierData);
router.post('/nguyen-lieu/deleteData/:id', authMiddlewares.ensureRoles(['Admin', 'Văn phòng', "Giám đốc"]),checkDateAccess, dailySupplyController.supplierInputController.deleteSupplierData);
...
router.post("/:slug/updatePrice/:supplierSlug?", authMiddlewares.ensureRoles(['Admin', 'Văn phòng', 'Giám đốc']),checkDateAccess, dailySupplyController.supplierExportController.updatePricesAndRatios)
