...
// Delete all users
router.post('/deleteAll', ...commonMiddlewares, accountController.deleteAllUsers);

// Log out
router.post('/logOut', authMiddlewares.ensureLoggedIn, authMiddlewares.ensureWorkingHours, accountController.logOut);
